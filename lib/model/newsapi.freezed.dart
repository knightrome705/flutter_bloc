...
class _$NewsApiImpl implements _NewsApi {
  const _$NewsApiImpl({required final List<Articles> articles})
      : _articles = articles;
  ...
  @override
  String toString() {
    return 'NewsApi(articles: $articles)';
  }
...
abstract class _NewsApi implements NewsApi {
  const factory _NewsApi({required final List<Articles> articles}) =
      _$NewsApiImpl;
...
abstract class _Articles implements Articles {
  const factory _Articles(
      ...
      required final String content}) = _$ArticlesImpl;
